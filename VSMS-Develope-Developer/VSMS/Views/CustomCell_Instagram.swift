...
//                let number = (((self.orderLabel?.text?.toInt())!) + ImageCount)
//                if newValue {
//                   self.instruction.isHidden = !newValue
//                    if number == 1 {
//                        self.instruction.text = "Front Image"
//                    }else if number == 2 {
//                        self.instruction.text = "Left Image"
//                    }else if number == 3 {
//                        self.instruction.text = "Right Image"
//                    }else {
//                        self.instruction.text = "Back Image"
//                    }
//                }
//                else {
